...
const (
	...
	apiModel   = "gemini-2.5-flash-preview-09-2025"
...
func main() {
	...
	dirFlag := flag.String("dir", "", "Required: Path to the image directory")
	forceFlag := flag.Bool("force", false, "Optional: Force re-generation of all captions, even if .txt files exist")
	identityFlag := flag.String("identity", "", "Optional: The trigger word (e.g., 'kongrongjin_3y') to prepend to each caption")
	flag.Parse()
